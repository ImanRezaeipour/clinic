...
namespace Clinic.Core.Utilities.Kendo
{
    public static class KendoQueryableExtensions
    {
        ...
        /// <returns>A DataSourceResult object populated from the processed IQueryable.</returns>
        public static KendoDataSourceResult ToDataSourceResult<T>(this IQueryable<T> queryable, KendoDataSourceRequest request)
        {
        ...
        private static object Aggregate<T>(IQueryable<T> queryable, IEnumerable<KendoAggregator> aggregates)
        {
