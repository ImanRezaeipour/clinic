...
namespace Advertise.Utility.Extensions
{
    ...
    public static class IAsyncEnumeratorExtensions
    {
        ...
        {
            return SingleAsync(source, IAsyncEnumerableExtensions.PredicateCache<TSource>.True, null, null, token, disposeSource);
        }
        ...
        public static Task<TSource> SingleAsync<TSource>(
            ...
            bool disposeSource = true)
        {
            return SingleAsync(source, IAsyncEnumerableExtensions.PredicateCache<TSource>.True, noneExceptionMessage, manyExceptionMessage, token, disposeSource);
        }
        ...
        public static Task<TSource> SingleOrDefaultAsync<TSource>(
            ...
            bool disposeSource = true)
        {
            return SingleOrDefaultAsync(source, IAsyncEnumerableExtensions.PredicateCache<TSource>.True, token, disposeSource);
        }
        ...
        public static Task<TSource> FirstAsync<TSource>(
            ...
            bool disposeSource = true)
        {
            return FirstAsync(source, IAsyncEnumerableExtensions.PredicateCache<TSource>.True, null, token, disposeSource);
        }
        ...
        public static Task<TSource> FirstAsync<TSource>(
            ...
            bool disposeSource = true)
        {
            return FirstAsync(source, IAsyncEnumerableExtensions.PredicateCache<TSource>.True, exceptionMessage, token, disposeSource);
        }
        ...
        public static Task<TSource> FirstOrDefaultAsync<TSource>(
            ...
            bool disposeSource = true)
        {
            return FirstOrDefaultAsync(source, IAsyncEnumerableExtensions.PredicateCache<TSource>.True, token, disposeSource);
        }
            ...
            bool disposeSource = true)
        {
            return Batch(source, batchSize, long.MaxValue, null,
                IAsyncEnumerableExtensions.BatchCollectionHelper<TSource>.GetCreateCollectionFunction<TStandardCollection>(),
                IAsyncEnumerableExtensions.BatchCollectionHelper<TSource>.GetAddToCollectionAction<TStandardCollection>(),
                disposeSource);
        }
