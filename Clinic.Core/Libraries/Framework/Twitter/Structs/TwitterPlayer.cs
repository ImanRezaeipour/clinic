namespace Boilerplate.Web.Mvc.Twitter
{
    ...
    public class TwitterPlayer
    {
        ...
        /// audio and video with the following codecs: Video: H.264, Baseline ProfilePage(BP), Level 3.0, up to 640 x 480 at
        /// 30 fps. Audio: AAC, Low Complexity ProfilePage(LC).
        /// </param>
        /// <exception cref="ArgumentNullException"><paramref name="playerUrl"/></exception>
        /// <exception cref="ArgumentOutOfRangeException">
        /// <paramref name="width"/> and <paramref name="height"/> must be more than zero.
        ...
        /// store a mix of audio and video with the following codecs: Video: H.264, Baseline ProfilePage(BP), Level 3.0, up
        /// to 640 x 480 at 30 fps. Audio: AAC, Low Complexity ProfilePage(LC).
        /// </summary>
