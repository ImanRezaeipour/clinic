...
namespace Clinic.Web.Controllers
{
    public partial class PatientController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> IsExistNationalCodeAjax()
        {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string IsExistNationalCodeAjax = "IsExistNationalCodeAjax";
        ...
        public class ActionNameConstants
        {
            ...
            public const string IsExistNationalCodeAjax = "IsExistNationalCodeAjax";
        ...
        static readonly ActionParamsClass_IsExistNationalCodeAjax s_params_IsExistNationalCodeAjax = new ActionParamsClass_IsExistNationalCodeAjax();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_IsExistNationalCodeAjax IsExistNationalCodeAjaxParams { get { return s_params_IsExistNationalCodeAjax; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_IsExistNationalCodeAjax
        {
            public readonly string nationalCode = "nationalCode";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Patient/Create.cshtml";
            public readonly string Edit = "~/Views/Patient/Edit.cshtml";
            public readonly string List = "~/Views/Patient/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PatientController : Clinic.Web.Controllers.PatientController
    {
        public T4MVC_PatientController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Clinic.Core.Models.Patient.PatientCreateViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Clinic.Core.Models.Patient.PatientCreateViewModel viewModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string nationalCode);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(string nationalCode)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "nationalCode", nationalCode);
            EditOverride(callInfo, nationalCode);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.ActionResult);
        }
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Clinic.Core.Models.Patient.PatientEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Clinic.Core.Models.Patient.PatientEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void IsExistNationalCodeAjaxOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, string nationalCode);
