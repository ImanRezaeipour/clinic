...
namespace Clinic.Web.Controllers
{
    public partial class PresenterController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Presenter/Create.cshtml";
            public readonly string Edit = "~/Views/Presenter/Edit.cshtml";
            public readonly string List = "~/Views/Presenter/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PresenterController : Clinic.Web.Controllers.PresenterController
    {
        public T4MVC_PresenterController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Clinic.Core.Models.Presenter.PresenterCreateViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Clinic.Core.Models.Presenter.PresenterCreateViewModel viewModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Clinic.Core.Models.Presenter.PresenterEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Clinic.Core.Models.Presenter.PresenterEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
