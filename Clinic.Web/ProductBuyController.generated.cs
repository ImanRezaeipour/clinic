...
{
    public partial class ProductBuyController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ProductBuyController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductBuyController Actions { get { return MVC.ProductBuy; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProductBuy";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProductBuy";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/ProductBuy/Create.cshtml";
            public readonly string Edit = "~/Views/ProductBuy/Edit.cshtml";
            public readonly string List = "~/Views/ProductBuy/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductBuyController : Clinic.Web.Controllers.ProductBuyController
    {
        public T4MVC_ProductBuyController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Clinic.Core.Models.ProductBuy.ProductBuyCreateViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Clinic.Core.Models.ProductBuy.ProductBuyCreateViewModel viewModel)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Clinic.Core.Models.ProductBuy.ProductBuyEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Edit(Clinic.Core.Models.ProductBuy.ProductBuyEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
