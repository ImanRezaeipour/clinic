...
namespace Clinic.Web.Controllers
{
    public partial class HomeController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual Clinic.FrameWork.Results.CaptchaImageResult CaptchaImage()
        {
            return new T4MVC_Clinic_FrameWork_Results_CaptchaImageResult(Area, Name, ActionNames.CaptchaImage);
        }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string Iman = "Iman";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Clinic.Web.Controllers.HomeController
    {
        public T4MVC_HomeController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CaptchaImageOverride(T4MVC_Clinic_FrameWork_Results_CaptchaImageResult callInfo, string rndDate);

        [NonAction]
        public override Clinic.FrameWork.Results.CaptchaImageResult CaptchaImage(string rndDate)
        {
            var callInfo = new T4MVC_Clinic_FrameWork_Results_CaptchaImageResult(Area, Name, ActionNames.CaptchaImage);
        ...
        [NonAction]
        partial void ImanOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Iman()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Iman);
            ImanOverride(callInfo);
            return callInfo;
        }
