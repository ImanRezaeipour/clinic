...
namespace Clinic.FrameWork.Filters
{
    ...
    public sealed class CaptchaValidateAttribute : ActionFilterAttribute
    {
        ...
        public CaptchaValidateAttribute(int expireTimeCaptchaCodeBySeconds = 30)
        {
        ...
        public CaptchaValidateAttribute(string errorWasHappened, string captchaCodeIsRequired, string captchaCodeIsIncorrect,
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            try
            {
                ...
                decryptedString = null; //todo: zarori hazf shod httpCookie.Value.Decrypt(DecryptionKey + DateTime.Now.Date.ToString());
            }
